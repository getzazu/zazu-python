"""Mirror of spec/support/fixture_ids.rb in zazu-ruby. Placeholders here must
exactly match what VCR scrubbed real staging UUIDs to when the cassettes were
recorded — otherwise the request URI won't match and replay will reject."""
...
TEST_API_KEY = "test-api-key-for-replay"
